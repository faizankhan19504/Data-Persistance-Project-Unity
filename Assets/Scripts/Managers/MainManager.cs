...
public class MainManager : MonoBehaviour
{
    ...
    private void AddPoint(int point)
    {
        ...
        if (m_Points > DataManager.Instance.highscoreData.highScore)
        {
            // Update the high score value
            DataManager.Instance.highscoreData.highScore = m_Points;

            // Update the name who set the score
            DataManager.Instance.highscoreData.highScoreName = DataManager.Instance.currentSessionPlayerName;
        }
    }
